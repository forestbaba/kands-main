...
public class SongOverviewActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DbBackend dbBackend = new DbBackend(SongOverviewActivity.this);
...
//        itemObject = dbBackend.getQuizById(dictionaryId);
...
//        Button textToSpeech = (Button)findViewById(R.id.button);
        ...
        showSong.setText(allQuizQuestions.getDefinition());
//        numberId.setText("Well");

//        numberId.setText(allQuizQuestions.getNumber());
